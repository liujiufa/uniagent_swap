    ...
    >
      <ModalContainer>
        ...
        <ModalContainer_Content>
          <NodeInfo>
            <HomeBox_Left_Price_Top>
              <div>Current Price</div> <div>Number of Nodes</div>
            </HomeBox_Left_Price_Top>
            <HomeBox_Left_Price_Bottom>
              <div>
                {600 ?? "-"} <span>UAC</span>
              </div>
              <Manage>
                ...
                <div>
                  <input
                    ...
                    onChange={(e: any) => {
                      ...
                      let filteredValue: any = String(value)?.replace(
                        /[+-]/g,
                        ""
                      );
                      // Remove + and - characters
                      // const decimalIndex = filteredValue?.replace(
                      //   /[^0-9]/g,
                      //   ""
                      // );
          ...
          <BtnBox>
            <Btn>Pledge 600 UAC to get 1 edge node</Btn>
            The profit will be calculated after 1000 blocks after staking. The
            principal will be returned after 10000 blocks after unstaking.
          </BtnBox>
        </ModalContainer_Content>
      </ModalContainer>
    </AllModal>
